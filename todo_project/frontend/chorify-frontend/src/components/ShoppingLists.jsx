            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="mb-3">
                            <label htmlFor="newShoppingListName" className="form-label">Name</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-3">
                            <label htmlFor="newShoppingListItem" className="form-label">Item</label>
                            <label htmlFor="newShoppingListQuantity" className="form-label ms-2">Quantity</label>
